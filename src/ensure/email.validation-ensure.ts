 ...
 * Ensure this field is a valid email address
 */
const ENSURE_EMAIL: ValidationEnsure = (): ValidationConfig => ({
    pattern: REGEX_EMAIL,
    description: template('ENSURE_EMAIL'),
  });

export default ENSURE_EMAIL;