...
import { ENSURE_ARRAYSIZEMAX, evalDesc, pluralize } from '../../../src';
...
describe('ENSURE_ARRAYSIZEMAX', () => {
  ...
  it('should have it\'s default description', () => {
    expect(evalDesc(ENSURE_ARRAYSIZEMAX(5).description)).to.equal(desc(5));
    expect(evalDesc(ENSURE_ARRAYSIZEMAX(1).description)).to.equal(desc(1));
  });
